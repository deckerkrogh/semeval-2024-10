...
# NOTE: the structure of the provided data is totally different from "MELD_train_efr.json". Use change_data_format
# script to make it usable.
...
for utt in idx2utt.values():
    ...
    if pp_utt != "pad":
      weight_matrix[utt2idx[pp_utt]] = sent2emb[pp_utt].detach().cpu()
